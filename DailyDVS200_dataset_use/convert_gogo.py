...
if __name__ == '__main__':
    ...
    process_dataset(converter=EventVoxelGridConverter(voxel_bin_num=9), file_extension='aedat4', num_workers=4)
    process_dataset(converter=EventGTEConverter(patch_size=(4, 4), group_num=12), file_extension='aedat4', num_workers=4)
